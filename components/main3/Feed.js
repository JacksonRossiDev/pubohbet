        ...
        renderItem={({ item }) => (
          ...
          <TouchableOpacity onPress={() =>
            props.navigation.navigate("PrePartyScreen", {
              ...
              userRiskerPPUrl: item?.userRisker?.ppUrl,
              creditBalance: item?.user?.creditBalance,
              withdrawBalance: item?.user?.withdrawBalance,
              myName: props.currentUser?.name

            })
          }
          // disabled={props.currentUser?.name !== item?.userRisker?.name}
              ...
              <View style={styles.postHeaderWrapper}>
                ...
                >
                  ...
                  <View style={styles.postHeaderTextWrapper}>
                    <Text style={styles.postHeaderTitle}>{item.user.name} challenged {item?.userRisker?.name}</Text>
